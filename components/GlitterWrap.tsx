...
const COMPONENT_DEFAULTS = {
  particleCount: 550,
  color1: "#ff1e27", // Vibrant Flame Red
  color2: "#e60026", // Deep Crimson Red
  color3: "#ffffff", // Pure Diamond Sparkle
  speed: 4,
  density: 100,
  starSize: 16,
  focalDepth: 13,
...
export default function GlitterWrap(props: GlitterWrapProps) {
  ...
  const colorCacheRef = useRef({
    ...
    color2: "" as string,
    color3: "" as string,
    parsed1: [255, 30, 39, 1] as [number, number, number, number],
    parsed2: [230, 0, 38, 1] as [number, number, number, number],
    parsed3: [255, 255, 255, 1] as [number, number, number, number],
  });
